...
operation:
  ...
  inputs:
    ...
    - subject
  sequential_action:
    gav: 'com.microfocus.seq:AOS.contact_form.ui.send_question_act:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      - step:
          ...
          action: Select
          default_args: '"Speakers"'
          snapshot: ".\\Snapshots\\ssf1.html"
          highlight_id: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebList("categoryListboxContactUs")'
          args: 'Parameter("catalog")'
      - step:
          id: '2'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebList("productListboxContactUs")'
          action: Select
          default_args: '"HP Roar Wireless Speaker"'
          snapshot: ".\\Snapshots\\ssf2.html"
          highlight_id: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebList("productListboxContactUs")'
          args: 'Parameter("item")'
      - step:
          id: '3'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("emailContactUs")'
          action: Set
          default_args: '"petr.panuska@microfocus.com"'
          snapshot: ".\\Snapshots\\ssf3.html"
          highlight_id: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("emailContactUs")'
          args: 'Parameter("email")'
      - step:
          id: '4'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("subjectTextareaContactUs")'
          action: Set
          default_args: '"I have a question"'
          snapshot: ".\\Snapshots\\ssf4.html"
          highlight_id: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("subjectTextareaContactUs")'
      ...
      - step:
          ...
          highlight_id: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebButton("send btnundefined")'
      - step:
          id: '6'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Thank you for contacting")'
          action: Output
          default_args: 'CheckPoint("contact_status")'
  outputs:
    - contact_status:
        robot: true
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="supportCover"]/DIV[2]/SEC-FORM[1]/DIV[1]/DIV[1]/SEC-VIEW[2]/DIV[1]/SELECT[@role="listbox"][1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                    ...
                    class: WebList
                    visual_relations: ''
                    last_update_time: 'Wednesday, May 13, 2020 11:06:07 AM'
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="supportCover"]/DIV[2]/SEC-FORM[1]/DIV[1]/DIV[1]/SEC-VIEW[1]/DIV[1]/SELECT[@role="listbox"][1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="supportCover"]/DIV[2]/SEC-FORM[1]/DIV[2]/DIV[1]/SEC-VIEW[1]/DIV[1]/TEXTAREA[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="supportCover"]/DIV[2]/SEC-FORM[1]/DIV[1]/DIV[1]/SEC-VIEW[3]/DIV[1]/INPUT[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
